    ...
    <div>
        ...
        <div className="flex pt-10">
          <div className="flex flex-col pr-5 ">
            ...
            <p className="pb-8 text-lg">{new Date(weatherData.sys.sunrise * 1000).toLocaleTimeString()}</p>
          ...
          <div className="flex flex-col pl-10">
            ...
            <p className="pb-8 text-lg">{new Date(weatherData.sys.sunset * 1000).toLocaleTimeString()}</p>
            <h1 className="text-xl font-semibold pb-2">Wind Speed</h1>
            <p className="pb-8 text-lg">{weatherData.wind.speed*3.6.toFixed(0)} km/h</p>
